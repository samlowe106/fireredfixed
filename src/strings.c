...
const u8 gText_Clefairy_400Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 400 COINS");
const u8 gText_Dratini_1500Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 1,500 COINS");
const u8 gText_Pinsir_2000Coins[] = _("PINSIR{CLEAR_TO 0x4B}{FONT_SMALL} 2,000 COINS");
const u8 gText_Scyther_4000Coins[] = _("SCYTHER{CLEAR_TO 0x4B}{FONT_SMALL} 4,000 COINS");
const u8 gText_NoThanks_2[] = _("NO THANKS");
const u8 gText_TradeStationKadabra[] = _("KADABRA");
const u8 gText_TradeStationMachoke[] = _("MACHOKE");
const u8 gText_TradeStationGraveler[] = _("GRAVELER");
const u8 gText_TradeStationHaunter[] = _("HAUNTER");
