...
extern const u8 gText_Clefairy_400Coins[];
extern const u8 gText_Dratini_1500Coins[];
extern const u8 gText_Pinsir_2000Coins[];
extern const u8 gText_Scyther_4000Coins[];
extern const u8 gText_NoThanks_2[];
extern const u8 gText_TradeStationKadabra[];
extern const u8 gText_TradeStationMachoke[];
extern const u8 gText_TradeStationGraveler[];
extern const u8 gText_TradeStationHaunter[];
